...
function createMCTileLayer(mapName, mapConfig, mapRotation) {
	...
	let cdnurl = `https://webpmaps.hermitguessr.ca/s${mapName.match(/\d+/)[0]}/`
	return new MCTileLayer(cdnurl + ["tl", "tr", "br", "bl"][mapRotation], {
...
MapcrafterUI.prototype.init = function() {
	...
	this.lmap.attributionControl.setPrefix("<a href='http://leafletjs.com/'>Leaflet</a> & <a href='http://mapcrafter.org'>Mapcrafter</a>");

	this.lmap.attributionControl.addAttribution(`https://discord.gg/8ydFhEV7Cq`);
...
MapcrafterUI.prototype.setMapAndRotation = function(map, rotation) {
	...
	if(oldMapLayer == null || oldMapConfig.world != mapConfig.world) {
		...
		this.lmap.setZoom(zoom, {animate : false});
		this.lmap.setView(this.mcToLatLng(mapConfig.defaultView[0], mapConfig.defaultView[1], mapConfig.defaultView[2]), zoom, {animate: false});
	}
